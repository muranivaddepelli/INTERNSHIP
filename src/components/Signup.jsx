  ...
  return (
    <div className='w-full max-w-sm bg-white p-6 rounded-2xl shadow-lg'>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          ...
          <button type='submit' className='w-full bg-green-500 text-white py-2 rounded-xl hover:bg-green-600'>Sign Up</button>
          <Link to='/login' className="text-blue-600 text-xl underline flex justify-center">Login</Link>
        </form>
